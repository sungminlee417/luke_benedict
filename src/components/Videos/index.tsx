...
const Videos = () => {
  const { recordings, youtubeChannel } = attributes as VideosData;
  ...
  // Filter only video content and limit to 4
  const videos = recordings.filter(recording => recording.type === "Video URL").slice(0, 4);
