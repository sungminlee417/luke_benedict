...
const Concert = ({ concert }: ConcertProps) => {
  return (
    <div className="card bg-white border border-gray-200 hover:border-primary/30 shadow-md hover:shadow-xl transform transition-all duration-300 hover:-translate-y-2 rounded-2xl overflow-hidden">
      <div className="card-body p-6">
        <div className="flex justify-between items-start mb-4">
          <div className="w-3 h-3 rounded-full bg-gradient-to-r from-primary to-secondary"></div>
          <span className="text-xs text-gray-500 font-medium uppercase tracking-wider">Concert</span>
        </div>
        <h3 className="text-xl font-bold text-neutral mb-3 leading-tight">{concert.title}</h3>
